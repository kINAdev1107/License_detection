...
#########################################################################
def FindLicenseNumber (gray,xmax,ymax, xmin, ymin, x_offset, y_offset,  License, x_resize, y_resize, \
...
from: https://www.kaggle.com/code/mclikmb4/vehicle-license-plate-detection-vgg16

Datasets from: https://www.kaggle.com/datasets/andrewmvd/car-plate-detection
...
print("Number of imagenes : " + str(len(X)))
print("Number of  labels : " + str(len(y)))
print("Number of   licenses : " + str(len(Licenses)))

TotHits=0
TotFailures=0
with open( "LicensesKaggleResults.txt" ,"w") as  w:
    for i in range (len(X)):
            ...
            TabLicensesFounded, ContLicensesFounded= FindLicenseNumber (gray,xmax,ymax, xmin,ymin, x_off, y_off,  License, x_resize, y_resize, \
                                   Resize_xfactor, Resize_yfactor, BilateralOption)
            ...
            if licensemax == License:
               ...
               TotHits+=1
                ...
                print(License + " assigned license " + licensemax)
                TotFailures +=1
            print ("")  
            lineaw=[]
...
print("")           
#print("Total Hits = " + str(TotHits ) + " from " + str(len(X)) + " images readed")
print( str(len(X)) + " images readed")
